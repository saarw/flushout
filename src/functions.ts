import { Model, CommandCompletion, CompletionBatch, CompletionError, Command } from "./types";
...
export function applyCompletions(model: Model<any>, completions: CommandCompletion[], pathMapper: PathMapper): 
    ...
    let modifiedBatch: CommandCompletion[] | undefined = undefined;
    let errors: CompletionError[] | undefined = undefined;
